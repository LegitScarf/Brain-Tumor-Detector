...
try:
    model = load_model('D:/Machine Learning/Model Deployment/brain_tumor_dataset/brain_tumor_model_quantized.tflite')
except Exception as e:
    st.error(f"Error loading the model: {e}. Please make sure the model file 'brain_tumor_model_quantized.tflite' is in the same directory as the script, or provide the correct path. 😕")
